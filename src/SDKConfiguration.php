...
class SDKConfiguration
{
    ...
    public string $userAgent = 'speakeasy-sdk/php 0.0.6 2.503.2 1.0.0 walker-tx/esv-sdk-php';
    ...
    public function getServerUrl(): string
    {
        ...
        if (isset(Esv::SERVERS[$this->serverIndex])) {
            return Esv::SERVERS[$this->serverIndex];
        } else {
    ...
    public function getServerDetails(): Utils\ServerDetails
    {
        ...
        return new Utils\ServerDetails(Esv::SERVERS[$this->serverIndex], []);
