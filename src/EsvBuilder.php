...
class EsvBuilder
{
     ...
     * @return EsvBuilder
     */
    public function setClient(\GuzzleHttp\ClientInterface $client): EsvBuilder
    {
     ...
     * @return EsvBuilder
     */
    public function setSecurity(string $apiKey): EsvBuilder
    {
     ...
     * @return EsvBuilder
     */
    public function setSecuritySource(\Closure $securitySource): EsvBuilder
    {
     ...
     * @return EsvBuilder
     */
    public function setServerUrl(string $serverUrl, ?array $params = null): EsvBuilder
    {
     ...
     * @return EsvBuilder
     */
    public function setServerIndex(int $serverIdx): EsvBuilder
    {
    ...
    public function setRetryConfig(Retry\RetryConfig $config): EsvBuilder
    {
